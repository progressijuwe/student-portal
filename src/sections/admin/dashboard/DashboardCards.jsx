...
export default function DashboardCards(){
    ...
    return(
        <div className='flex shrink-0 w-full gap-5 overflow-x-auto md:overflow-visible'  style={{ scrollbarWidth: 'none'}}>
            {details.map((det) => (
                <div key={det.label} className='flex justify-between gap-2 bg-white rounded-[20px] border border-brand-orange p-4 w-full max-w-40.5 shrink-0 md:shrink sm:max-w-67.5 xl:max-w-70'>
