...
export default function QuickActions(){
    ...
    const actions = [
        { key: "add-student", label: "Add Student", Icon: Person, PlusIcon: Plus, bgColor: "#DBEAFE", iconClass: "[&_path]:stroke-brand-blue-border [&_path]:fill-brand-blue-border", Modal: AddStudentModal },
        { key: "add-lecturer", label: "Add Lecturer", Icon: Person, PlusIcon: Plus, bgColor: "#FFEDD4", iconClass: "[&_path]:stroke-brand-orange [&_path]:fill-brand-orange", Modal: AddLecturerModal },
