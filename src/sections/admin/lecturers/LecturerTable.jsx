...
export default function LecturerTable({ lecturers, loading, error, onRetry, onView, onEdit, onDelete }) {
    return (
        <DataTable
            items={lecturers}
            loading={loading}
            ...
            renderRow={(lecturer) => (
                <UserRow key={lecturer.id} user={lecturer} onView={onView} onEdit={onEdit} onDelete={onDelete} />
            )}
            renderCard={(lecturer) => (
                <UserCard key={lecturer.id} user={lecturer} onView={onView} onEdit={onEdit} onDelete={onDelete} />
            )}
        />
    )
}