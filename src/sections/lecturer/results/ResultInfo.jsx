...
export default function ResultInfo({
	...
	return (
		<section
			className='p-3 lg:p-4 rounded-[10px] bg-white shadow-[0px_1px_2px_-1px_rgba(0,0,0,0.1)]'
			aria-label='Result Information'
		>
			<div className='flex flex-col gap-4'>
				<div className='flex flex-col gap-7'>
					<div className='flex gap-3 items-center'>
						<span className='rounded-[10px] p-3 bg-[#FFEDD4]'>
							<Results
								aria-hidden='true'
								className='size-6 [&_path]:stroke-brand-orange'
							/>
						</span>
						<div className='flex flex-col'>
							<h3 className='font-semibold text-[#101828] text-sm lg:text-base'>
								{code}
							</h3>
							<p className='text-sm text-[#4A5565] lg:text-base'>
								{title}
							</p>
						</div>
					</div>
